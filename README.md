...
- [Mori (森)](https://github.com/fjwood69/mori) - Sovereign shared memory layer for AI coding agents — zero-instrumentation capture via lifecycle hooks, dream pipeline distils sessions into curated governed memories, works across Claude Code, Cursor, Codex, and Antigravity (🏷️ `Python` `MCP` `Self-Hosted` `Governance` `Sovereign`).
